...
from neurosynth_compose_sdk.models.specification_post_body import SpecificationPostBody  # noqa: E501
...
class TestSpecificationPostBody(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `SpecificationPostBody`
        """
        model = neurosynth_compose_sdk.models.specification_post_body.SpecificationPostBody()  # noqa: E501
        if include_optional :
            return SpecificationPostBody(
                type = '', 
