...
class ReadOnly(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "updated_at", "created_at", "user", "username", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "updated_at", "created_at", "user", "username", ], str]):
