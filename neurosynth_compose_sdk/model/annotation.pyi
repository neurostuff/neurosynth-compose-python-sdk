...
class Annotation(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["neurostore_id", "snapshot", "studyset", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["neurostore_id", "snapshot", "studyset", ], str]):
