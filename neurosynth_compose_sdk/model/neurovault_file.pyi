...
class NeurovaultFile(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["collection_id", "exception", "traceback", "status", "image_id", "name", "url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["collection_id", "exception", "traceback", "status", "image_id", "name", "url", ], str]):
