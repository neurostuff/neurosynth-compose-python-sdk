...
class SpecificationList(BaseModel):
    ...
    """ # noqa: E501
    results: Optional[List[SpecificationReturn]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [SpecificationReturn.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
