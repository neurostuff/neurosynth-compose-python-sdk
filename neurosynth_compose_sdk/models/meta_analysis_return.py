...
class MetaAnalysisReturn(BaseModel):
    ...
    __properties = ["specification", "studyset", "annotation", "name", "description", "internal_studyset_id", "internal_annotation_id", "results", "provenance", "project", "id", "updated_at", "created_at", "user"]
