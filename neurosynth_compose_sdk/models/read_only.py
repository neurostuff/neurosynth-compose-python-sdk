...
class ReadOnly(BaseModel):
    ...
    __properties = ["id", "updated_at", "created_at", "user", "username"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReadOnly:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReadOnly:
        """Create an instance of ReadOnly from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReadOnly.parse_obj(obj)

        _obj = ReadOnly.parse_obj({
            "id": obj.get("id"),
