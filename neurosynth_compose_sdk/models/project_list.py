...
class ProjectList(BaseModel):
    ...
    ProjectList
    """
    results: Optional[conlist(ProjectReturn)] = None
    ...
    def from_dict(cls, obj: dict) -> ProjectList:
        ...
        _obj = ProjectList.parse_obj({
            "results": [ProjectReturn.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
