...
class NeurostoreStudyReturn(BaseModel):
    """
    ...
    __properties = ["neurostore_id", "analyses", "exception", "traceback", "status", "id", "updated_at", "created_at", "user", "username"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NeurostoreStudyReturn:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NeurostoreStudyReturn:
        """Create an instance of NeurostoreStudyReturn from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NeurostoreStudyReturn.parse_obj(obj)
