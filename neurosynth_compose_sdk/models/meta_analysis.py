...
T = TypeVar("T", bound="MetaAnalysis")


@attr.s(auto_attribs=True)
class MetaAnalysis:
    """The combination of the specification determining what meta-analysis to run (required), the studyset to act as input
    to the meta-analytic algorithm (required), and the annotation to provide human readable annotations as well as acts
    as an optional filter on which analyses to select within the studyset (optional, but suggested).
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        meta_analysis.additional_properties = d
