...
T = TypeVar("T", bound="MetaAnalysisPostBody")


@attr.s(auto_attribs=True)
class MetaAnalysisPostBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        meta_analysis_post_body.additional_properties = d
        return meta_analysis_post_body
