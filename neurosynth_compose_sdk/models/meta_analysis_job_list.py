...
class MetaAnalysisJobList(BaseModel):
    """
    MetaAnalysisJobList
    """ # noqa: E501
    results: Optional[List[MetaAnalysisJobResponse]] = None
    metadata: Optional[MetaAnalysisJobListMetadata] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [MetaAnalysisJobResponse.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "metadata": MetaAnalysisJobListMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
