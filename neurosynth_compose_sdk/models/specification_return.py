...
class SpecificationReturn(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "estimator", "mask", "conditions", "weights", "transformer", "corrector", "filter", "database_studyset", "id", "updated_at", "created_at", "user", "username"]
