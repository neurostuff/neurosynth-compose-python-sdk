...
class NeurostoreAnalysis(BaseModel):
    """
    NeurostoreAnalysis
    """
    ...
    __properties = ["neurostore_id", "exception", "traceback", "status"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NeurostoreAnalysis:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NeurostoreAnalysis:
        """Create an instance of NeurostoreAnalysis from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NeurostoreAnalysis.parse_obj(obj)

        _obj = NeurostoreAnalysis.parse_obj({
