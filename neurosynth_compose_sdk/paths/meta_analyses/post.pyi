...
# body param
SchemaForRequestBodyApplicationJson = MetaAnalysisPostBody


request_body_meta_analysis_post_body = api_client.RequestBody(
    content={
...
class SchemaFor500ResponseBodyApplicationProblemjson(
    schemas.DictSchema
):
...
class BaseApi(api_client.Api):
    ...
    def _meta_analyses_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_meta_analysis_post_body.serialize(body, content_type)
...
class MetaAnalysesPost(BaseApi):
    ...
    def meta_analyses_post(
        ...
        return self._meta_analyses_post_oapg(
            body=body,
