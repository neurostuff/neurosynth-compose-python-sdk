...
# body param
SchemaForRequestBodyApplicationJson = Specification


request_body_specification = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SpecificationReturn
...
class SchemaFor401ResponseBodyApplicationProblemjson(
    schemas.DictSchema
):
...
class SchemaFor404ResponseBodyApplicationProblemjson(
    schemas.DictSchema
):
...
class SchemaFor422ResponseBodyApplicationProblemjson(
    schemas.DictSchema
):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _specifications_id_put_oapg(
        self,
    ...
    def _specifications_id_put_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_specification.serialize(body, content_type)
...
class SpecificationsIdPut(BaseApi):
    ...
    def specifications_id_put(
        ...
        return self._specifications_id_put_oapg(
            body=body,
