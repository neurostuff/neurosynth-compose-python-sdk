...
# body param
SchemaForRequestBodyApplicationJson = AnnotationUpdate


request_body_annotation_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _annotations_id_put_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_annotation_update.serialize(body, content_type)
