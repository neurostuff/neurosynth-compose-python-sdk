...
SchemaFor200ResponseBodyApplicationJson = StudysetReferenceReturn
...
class BaseApi(api_client.Api):
    @typing.overload
    def _studyset_references_id_get_oapg(
        self,
...
class StudysetReferencesIdGet(BaseApi):
    ...
    def studyset_references_id_get(
        ...
        return self._studyset_references_id_get_oapg(
