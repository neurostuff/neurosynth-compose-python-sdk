...
SchemaFor200ResponseBodyApplicationJson = NeurovaultFileList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _neurovault_files_get_oapg(
        self,
...
class NeurovaultFilesGet(BaseApi):
    ...
    def neurovault_files_get(
        ...
        return self._neurovault_files_get_oapg(
