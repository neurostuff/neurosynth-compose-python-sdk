...
SchemaFor200ResponseBodyApplicationJson = StudysetReferenceList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _studyset_references_get_oapg(
        self,
...
class StudysetReferencesGet(BaseApi):
    ...
    def studyset_references_get(
        ...
        return self._studyset_references_get_oapg(
