...
# body param
SchemaForRequestBodyApplicationJson = StudysetPostBody


request_body_studyset_post_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _studysets_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_studyset_post_body.serialize(body, content_type)
