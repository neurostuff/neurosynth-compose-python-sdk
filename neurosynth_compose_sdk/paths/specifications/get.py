...
SchemaFor200ResponseBodyApplicationJson = SpecificationList
...
class SpecificationsGet(BaseApi):
    ...
    def specifications_get(
        ...
        return self._specifications_get_oapg(
