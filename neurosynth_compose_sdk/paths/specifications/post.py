...
# body param
SchemaForRequestBodyApplicationJson = SpecificationPostBody


request_body_specification_post_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _specifications_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_specification_post_body.serialize(body, content_type)
...
class SpecificationsPost(BaseApi):
    ...
    def specifications_post(
        ...
        return self._specifications_post_oapg(
            body=body,
