...
# body param
SchemaForRequestBodyMultipartFormData = NeurovaultFile
...
class BaseApi(api_client.Api):
    @typing.overload
    def _neurovault_files_id_put_oapg(
        self,
...
class NeurovaultFilesIdPut(BaseApi):
    ...
    def neurovault_files_id_put(
        ...
        return self._neurovault_files_id_put_oapg(
            body=body,
