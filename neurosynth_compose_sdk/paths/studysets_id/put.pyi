...
# body param
SchemaForRequestBodyApplicationJson = Studyset


request_body_studyset = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _studysets_id_put_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_studyset.serialize(body, content_type)
