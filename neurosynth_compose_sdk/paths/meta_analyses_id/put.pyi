...
# body param
SchemaForRequestBodyApplicationJson = MetaAnalysis


request_body_meta_analysis = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = MetaAnalysisReturn
...
class BaseApi(api_client.Api):
    @typing.overload
    def _meta_analyses_id_put_oapg(
        self,
    ...
    def _meta_analyses_id_put_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_meta_analysis.serialize(body, content_type)
...
class MetaAnalysesIdPut(BaseApi):
    ...
    def meta_analyses_id_put(
        ...
        return self._meta_analyses_id_put_oapg(
            body=body,
