...
**cached_studyset_id** | str,  | str,  | The id of the studyset on neurosynth-compose (as opposed to the id of the studyset on neurostore). Multiple snapshots of the studyset can be stored on neurosynth-compose so knowing which snapshot is being referenced is necessary. | [optional] 
**cached_annotation_id** | str,  | str,  | The id of the annotation on neurosynth-compose (as opposed to the id of the annotation on neurostore). Multiple snapshots of the annotation can be stored on neurosynth-compose so knowing which snapshot is being referenced is necessary. | [optional] 
...
**neurostore_analysis** | [**NeurostoreAnalysis**](NeurostoreAnalysis.md) | [**NeurostoreAnalysis**](NeurostoreAnalysis.md) |  | [optional] 
