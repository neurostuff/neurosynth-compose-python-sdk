...
[**tags_get**](GetApi.md#tags_get) | **GET** /tags | Get a list of Tags
[**tags_id_get**](GetApi.md#tags_id_get) | **GET** /tags/{id} | Get information about a Tag
...
with neurosynth_compose_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GetApi->tags_get:\n")
        pprint(api_response)
    except Exception as e:
...
with neurosynth_compose_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GetApi->tags_id_get:\n")
        pprint(api_response)
    except Exception as e:
