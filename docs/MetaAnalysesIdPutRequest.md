...
json = "{}"
# create an instance of MetaAnalysesIdPutRequest from a JSON string
meta_analyses_id_put_request_instance = MetaAnalysesIdPutRequest.from_json(json)
# print the JSON string representation of the object
print MetaAnalysesIdPutRequest.to_json()

# convert the object into a dict
meta_analyses_id_put_request_dict = meta_analyses_id_put_request_instance.to_dict()
# create an instance of MetaAnalysesIdPutRequest from a dict
meta_analyses_id_put_request_form_dict = meta_analyses_id_put_request.from_dict(meta_analyses_id_put_request_dict)
```
