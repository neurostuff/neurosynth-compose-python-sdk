...
<a id="meta_analysis_results_get"></a>
...
<a id="meta_analysis_results_id_get"></a>
...
<a id="meta_analysis_results_id_put"></a>
...
with neurosynth_compose_sdk.ApiClient(configuration) as api_client:
    ...
    body = Result(
        ...
        neurovault_collection=NeurovaultCollectionReturn(None),
...
<a id="neurovault_collections_get"></a>
> neurovault_collections_get()
...
<a id="neurovault_collections_id_get"></a>
...
<a id="neurovault_collections_id_put"></a>
...
<a id="neurovault_files_id_get"></a>
...
<a id="neurovault_files_id_put"></a>
